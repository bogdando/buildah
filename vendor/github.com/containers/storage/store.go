...
type Store interface {
	...
	ApplyDiffWithDiffer(to string, options *drivers.ApplyDiffOpts, data interface{}, differ drivers.DifferFunction) (*drivers.DriverWithDifferOutput, error)
...
func (s *store) ApplyDiffWithDiffer(to string, options *drivers.ApplyDiffOpts, data interface{}, differ drivers.DifferFunction) (*drivers.DriverWithDifferOutput, error) {
	rlstore, err := s.LayerStore()
	if err != nil {
		return nil, err
	}
	...
	return rlstore.ApplyDiffWithDiffer(to, options, data, differ)
}
