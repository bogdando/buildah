...
type DifferFunction func(data interface{}, dest string, options *archive.TarOptions) (DriverWithDifferOutput, error)
...
type DriverWithDiffer interface {
	...
	ApplyDiffWithDiffer(id, parent string, options *ApplyDiffOpts, data interface{}, differ DifferFunction) (output DriverWithDifferOutput, err error)
